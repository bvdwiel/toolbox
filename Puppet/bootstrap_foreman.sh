...
pkg update
pkg upgrade
pkg install -y www/node www/npm devel/git devel/libvirt sysutils/rubygem-bundler rubygem-pkg-config databases/postgresql95-client databases/sqlite3 databases/mysql56-client devel/pkgconf lang/phantomjs archivers/zopfli textproc/libsasst extproc/sassc lang/gcc
cd /root
